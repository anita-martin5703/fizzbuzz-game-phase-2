 ...
 * return <code>boolean</code> and {@link String}
 * results, indicting whether the specified values are divisible by 3 (fizz)
 * or 5 (buzz). </p>
 *
...
public class FizzBuzz {
  ...
  /**
   * Returns <code>value</code> if divisible by 3 using <code>boolean</code>
   * @param value Integer value to be tested.
   * @return isFizz, isBuzz, or value as a {@link String}.
   */
  ...
  /**
   * Returns <code>value</code> if divisible by 5 using <code>boolean</code>
   * @param value Integer value to be tested.
   * @return "isFizz", "isBuzz", or value as a {@link String}.
   */
